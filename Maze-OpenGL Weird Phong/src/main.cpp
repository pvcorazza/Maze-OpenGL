...
"           attenuation = 1000.0/(angleSpotlight * angleSpotlight * angleSpotlight);"   // PARA BOTAR TEMPO, É SÓ FAZER ESSE VALOR DE 1000 BAIXAR E TAMBÉM O 10.0 DO IF PRECISA SER EM FUNÇÃO DELE
...
"       } \n"
"\n"
"       FragColor += attenuation * ((vec4(0.2f,0.2f,0.2f,1.0f) * texture(TEX, finalTex) *  cosAngle) + vec4(specular,1.0f)); \n"   // * vec4(specular,1.0f)
...
float vertices5[] = {                 // sky
    ...
    */
    ...
    const std::string filename3("C://Users//mjwille//Downloads//Maze-OpenGL-master//nightSky.jpg");
